// capabilities/visualization/RingCapability.ts
...
export class RingCapability implements CapabilityDefinition {
  readonly metadata = {
    id: "visualization.ring",
    name: "Ring",
    category: "visualization",
    description: "Ring visualization capability.",
    version: "GMC-1.0.0",
    defaultEnabled: true,
  } as const;
