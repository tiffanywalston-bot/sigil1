// capabilities/visualization/HarmonicCapability.ts
...
export class HarmonicCapability implements CapabilityDefinition {
  readonly metadata = {
    id: "visualization.harmonic",
    name: "Harmonic",
    category: "visualization",
    description: "Harmonic visualization capability.",
    version: "GMC-1.0.0",
    defaultEnabled: true,
  } as const;
