// capabilities/visualization/GeometryCapability.ts
...
export class GeometryCapability implements CapabilityDefinition {
  readonly metadata = {
    id: "visualization.geometry",
    name: "Geometry",
    category: "visualization",
    description: "Geometry visualization capability.",
    version: "GMC-1.0.0",
    defaultEnabled: true,
  };
